...
add wave /signed_mult_sum_tb/rst
add wave /signed_mult_sum_tb/vld
add wave /signed_mult_sum_tb/neg
add wave -expand -dec /signed_mult_sum_tb/x ( -child \
...
add wave -expand -dec /signed_mult_sum_tb/y ( -child \
...
add wave /signed_mult_sum_tb/us/gn/dsp_out
add wave /signed_mult_sum_tb/us/gn/dsp_vld
add wave -dec /signed_mult_sum_tb/us/gn/DSP_PIPESTAGES
add wave /signed_mult_sum_tb/us/gn/adder_in
wv.cursors.add -time 1us+1 -name {Default cursor}
wv.cursors.setactive -name {Default cursor}
wv.zoom.range -from 66900ps -to 218ns
